...
import logoImage from './Assets/logotour.png';
    ...
    <div className="nav-container d-flex flex-column align-items-center">
      ...
      <nav className={`nav ${isNavVisible ? 'show' : 'hidden'}`}>
        ...
        <ul className="sidenav-list d-flex flex-column justify-content-center align-items-center">
          <li className="sidenav-item">
            <NavLink to="/packages" className="sidenav-link" onClick={toggleSidebar}>
              Packages
            </NavLink>
          </li>
          <li className="sidenav-item">
            <NavLink to="/reservations" className="sidenav-link" onClick={toggleSidebar}>
              Reservations
            </NavLink>
          </li>
          ...
          <>
            <li className="sidenav-item">
              <NavLink to="/add_package" className="sidenav-link" onClick={toggleSidebar}>
                Package +
              </NavLink>
            </li>
            <li className="sidenav-item">
              <NavLink to="/delete-packages" className="sidenav-link" onClick={toggleSidebar}>
                Package -
              </NavLink>
            </li>
          </>
          ...
          <li className="sidenav-item">
            <NavLink to="/add_reservations" className="sidenav-link" onClick={toggleSidebar}>
              Reservation +
            </NavLink>
          </li>
          <li className="sidenav-item">
            <NavLink to="/remove_reservations" className="sidenav-link" onClick={toggleSidebar}>
              Reservations -
            </NavLink>
          </li>
          <li className="sidenav-item">
